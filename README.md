# 🌳 Semantic Parsing Model Collections

This repository machine learning models of Semantic Parsing, designed to be deployed using ONNX and utilized in a Streamlit-based web application. The app provides an interactive interface for performing various tasks using neural network architectures. [Check here to see other ML models](https://github.com/verneylmavt/ml-model).

## 🎈 Demo App

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://verneylogyt-sm-parsing.streamlit.app/)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/verneylmavt/st-sm-parsing.git
   cd st-sm-parsing
   ```
